...
@RestController
@RequestMapping(value = "/api/vehicleBasicPricess", produces = MediaType.APPLICATION_JSON_VALUE)
public class VehicleBasicPricesResource {
    ...
    @GetMapping
    public ResponseEntity<List<VehicleBasicPricesDTO>> getAllVehicleBasicPricess() {
